...
Working algorithm:
1)Write from buffer in char* variable 
2)Execute method in thread from main loop
3)Method change pointer char* variable value and copy char* data in res var
4)Measuring char* data variable and create audio buffer with this length
5)Copy play buffer in big play buffer
6)Play
